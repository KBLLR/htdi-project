 ...
 * @param {object} [options={}] - Options to override default control settings.
 * @returns {OrbitControls} The created OrbitControls instance.
 */
 ...
 * @param {OrbitControls} controls - The OrbitControls instance to modify.
 * @param {string} presetName - The name of the control preset to apply ('overview' or 'focus').
 */
